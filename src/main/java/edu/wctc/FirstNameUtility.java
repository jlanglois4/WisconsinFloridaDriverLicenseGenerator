...
public class FirstNameUtility {
    private static Map<String, Integer> firstNameCodeMap = new HashMap<>();
    private static Map<String, Integer> firstInitialCodeMap = new HashMap<>();
    private static Map<String, Integer> middleInitialCodeMap = new HashMap<>();
    ...
    public static int encodeFirstName(String firstName, String middleInitial) throws MissingNameException {
        ...
        if (firstNameCodeMap.containsKey(firstName)) {
            //return sum of the codes for the firstname and middle initial
            firstVal = firstNameCodeMap.get(firstName);

        } else {
            //return sum of codes for the first name initial
           firstVal = firstInitialCodeMap.get(firstName.charAt(0) + "");

        }

        if (middleInitialCodeMap.containsKey(middleInitial)) {
            //return first name or first initial code
            secondVal = middleInitialCodeMap.get(middleInitial);
        }
